...
void StatusBar::setUp(const std::string name, sf::Vector2f& pos, sf::Vector2f& size, int minValue, int currValue, int maxValue, int fillDirec, sf::Color& backColor, sf::Color& fillCol, sf::Font& valuesFont, sf::Color textColor, bool textVisible, bool valsAsPercent)
{
